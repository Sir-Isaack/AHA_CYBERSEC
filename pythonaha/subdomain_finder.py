...
# Discord uses a webhook URL.
# Slack uses a webhook URL.
#
# If N/A or a blank value is provided for a notification
# channel, that channel is skipped without displaying an
# unnecessary information message.
#
...
discord_webhook = input(
    "Enter Discord webhook URL (N/A to skip): "
).strip()

if discord_webhook.lower() == "n/a":
    discord_webhook = ""
